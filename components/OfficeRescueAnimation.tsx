...
export function OfficeRescueAnimation() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute right-2 top-4 flex items-center gap-1.5 rounded-pill bg-gold px-3.5 py-2 text-sm font-semibold text-oat shadow-md transition-all duration-500 ${
